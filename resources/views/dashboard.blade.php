    ...
    <div class="eq-page">
        <div class="eq-container">
            <section class="eq-hero-panel">
                <div class="grid gap-6 lg:grid-cols-[1.15fr_0.85fr] lg:items-center">
                    <div>
                        ...
                        <h3 class="mt-4 text-2xl font-black tracking-tight text-slate-950 sm:text-3xl">
                    ...
                    <div class="grid gap-3 sm:grid-cols-3 lg:grid-cols-1">
                        <div class="eq-stat-card">
                            ...
                            <p class="mt-1 text-2xl font-black tabular-nums text-slate-950">{{ $stats['activeCourses'] }}</p>
                        </div>
                        <div class="eq-stat-card">
                            <p class="text-sm font-semibold text-slate-500">Active quizzes</p>
                            <p class="mt-1 text-2xl font-black tabular-nums text-slate-950">{{ $stats['activeQuizzes'] }}</p>
                        </div>
                        <div class="eq-stat-card">
            ...
            <section class="mt-6 grid gap-4 md:grid-cols-3">
                <a href="{{ route('courses.index') }}" class="eq-card min-h-[132px]">
                    <p class="text-sm font-bold text-emerald-700">Browse Courses</p>
                    <h3 class="mt-2 text-lg font-bold text-slate-950">Find the next quiz</h3>
                    <p class="mt-2 eq-muted">See active courses and open available quizzes.</p>
                </a>
                <a href="{{ route('attempts.index') }}" class="eq-card min-h-[132px]">
                    <p class="text-sm font-bold text-emerald-700">View Quiz History</p>
                    <h3 class="mt-2 text-lg font-bold text-slate-950">Review saved results</h3>
