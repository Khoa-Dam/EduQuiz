                ...
                <div class="p-6">
                    @if ($questions->isEmpty())
                        <div class="rounded-md border border-dashed border-gray-300 p-8 text-center">
                            ...
                            <p class="mt-1 text-sm text-gray-600">Create questions after a quiz exists.</p>
                        </div>
                    @else
                                            ...
                                            <td class="px-4 py-3 text-right">
                                                <div class="flex justify-end gap-3">
                                                    ...
                                                    <form method="POST" action="{{ route('admin.questions.destroy', $question) }}">
                                                        @csrf
                                                        @method('DELETE')
                                                        <button type="submit" class="font-medium text-red-700 hover:text-red-900" onclick="return confirm('Delete this question?')">
                                                            Delete
                                                        </button>
                                                    </form>
                                                </div>
